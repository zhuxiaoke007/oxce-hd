...
| SHA-256 | `EB5A94353…`（2026-08-25 重建：P9 弹出窗口遮挡修复，见 `P9_Popup_Occlusion_Fix_Report.md`） |
| 大小 | 23,238,741 字节 |
| 修改时间 | 2026-08-25（P9 修复构建） |
...
> - `EB5A9435...`（2026-08-25 最新）：P9 弹出窗口遮挡修复——Window::blit 覆写 + Screen::clearTextOverlayRect（窗口背景绘制前清掉覆盖层矩形墨迹，下拉菜单不再有背景正文穿透）。
